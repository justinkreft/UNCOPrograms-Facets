...
// HTML interface.
  ...
  , facets :
    { 'roll_call.vote_type' : 'Vote Type'
    , 'roll_call.congressional_session' : 'Congressional Session'
    , 'roll_call.majority_requirement' : 'Majority Requirement'
    , 'legislator.party_affiliation' : 'Party Affiliation'
    , 'legislator.state_representing' : 'Party Affiliation'
    , vote_cast : 'Vote Cast'
    }
...
//    display as the resource name:
  ...
  , name : [ 'legislator.last_name', 'legislator.party_affiliation', 'legislator.state_representing']

// OPTIONAL.
// If your resources have descriptions, set the value of `description`
// to the name of the property holding the descriptive text.

  , description : ['roll_call.vote_title', 'roll_call.vote_question', 'roll_call.vote_result']
...
// this sorting option to appear in the HTML interface.
  ...
  , orderby :
    { 'legislator.last_name' : 'Last Name'
    , 'legislator.party_affiliation' : 'Party'
    , 'legislator.state_representing' : 'State Representing'
    , vote_cast : 'Vote Cast'
    }
